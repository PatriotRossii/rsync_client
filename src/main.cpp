...
int main(int argc, char *argv[]) try {
    ...
    if (vm.count("signature")) {
        ...
        auto result = rs_sig_file(source_file, destination_file, 0, 0,
                                  static_cast<rs_magic_number>(0), nullptr);
        ...
        auto result =
            rs_delta_file(sig, source_file, destination_file, nullptr);
        ...
        auto result =
            rs_patch_file(source_file, delta_file, destination_file, nullptr);
